...
const PriceCard: VFC<Props> = ({
  ...
  return (
    <div className="indicator">
      {choosen && (
        <span className="indicator-item indicator-center badge badge-accent text-primary-content">
          Most Popular
        </span>
      )}
      <div
        className={`card card-compact bg-base-100 ${border} transition duration-300`}
      >
        ...
        <div className="card-body mx-5 my-2">
          ...
          <div className="card-actions">
            <button className="btn btn-primary btn-block">Buy {title}</button>
          </div>
        </div>
      </div>
    </div>
